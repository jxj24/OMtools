...
% Last Modified by GUIDE v2.5 28-Feb-2017 14:25:53
...
for sacc_num = 1:length(h.eye_data.(eye_str).saccades.sacclist.start)
   ...
   line( time1, y, 'Tag', ['saccade_' eye_str '_begin'], 'Color', beg_line_color, ...
   ...
   line( time2, y, 'Tag', ['saccade_' eye_str '_#' num2str(sacc_num) '_begin'], ...
      'Color', end_line_color, 'Marker', 'o', 'MarkerSize', 10);
